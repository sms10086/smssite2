...
public class ChineseCalendar {									final static long[] lunarInfo=new long[]
								...
								public static String getChinaMon(int month){
								       String n="";
								       switch(month){
								       case 1:n="正";break;
								       case 2:n="二";break;
								 ...
								 public static String getLunar(Calendar cld){
								      ...
								      String a = "今天"+year+"年"+month+"月"+day+"日  星期"+week+"　农历"+((int)l[6]==1? "闰" : "")+getChinaMon((int)(l[1]))+"月"+getchina((int)(l[2]))+" "+cyclicalm((int)l[3])+"年"+"("+AnimalsYear((int)l[0])+")";//+cyclicalm((int)l[4])+"月"+cyclicalm((int)l[5])+"日";
								      return a;
								    }
}
